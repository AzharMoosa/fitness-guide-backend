const legExercises = [{
            ...
            type: "Leg Exercises",
            description: "Take two dumbbells in your hands stand straight feet about shoulder wide. Take one long step so that the front knee is approximately forming a right angle. The back leg is streched the knee is low but doesnt touch the ground. Complete the step by standing up and repeat the movement with the other leg.",
            info: "",
          },{
            name: "Forward Lunge",
            type: "Leg Exercises",
            ...
            name: "Overhead Squat",
            type: "Leg Exercises",
            description: "The barbell is held overhead in a wide- armsnatchgrip however it is also possible to use a closer grip if balance allows.",
            info: "",
          },{
            name: "Pistol Squat",
            type: "Leg Exercises",
            ...
            type: "Leg Exercises",
            description: "DL from top to pos 2httpswww.youtube.comwatchvWtWtjViRsKo",
            info: "",
          },{
            name: "Run",
            type: "Leg Exercises",
            ...
            name: "Speed Deadlift",
            type: "Leg Exercises",
            description: "Deadlift with short lt1min rest between sets.",
            info: "",
          },{
            name: "Squat Jumps",
            type: "Leg Exercises",
            ...
            type: "Leg Exercises",
            description: "Ride a Stationary Bike with varioustensions.",
            info: "",
          },{
            ...
            name: "Thruster",
            type: "Leg Exercises",
            description: " Start by doing a front squatAt the top position push the bar above your head similar to a pressLower the bar to the shoulders",
            info: "",
